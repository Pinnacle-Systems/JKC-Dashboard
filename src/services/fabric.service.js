...
SELECT A.FINYR,A.BUYERNAME,A.BUYERCODE,A.ORDERNO,A.BUYERPONO,A.STYLE,A.ORDERQTY,A.YPOQTY,A.YARNQTY,
A.KNITRECQTY,A.KNITBAL,A.DYERECQTY,A.INBAL,A.ORD,A.TYPENAME FROM (SELECT A.FINYR,A.BUYERNAME,A.BUYERCODE,A.ORDERNO
,A.BUYERPONO,A.STYLE,A.ORDERQTY,A.YPOQTY,A.YARNQTY,A.KNITRECQTY,A.KNITBAL,A.DYERECQTY,A.INBAL,3 ORD,'FABRIC INHOUSE PENDING' TYPENAME FROM FABINHOUSE
 A UNION ALL SELECT A.FINYR,A.BUYERNAME,A.BUYERCODE,A.ORDERNO,A.BUYERPONO,A.STYLE,A.ORDERQTY,A.YPOQTY,A.YARNQTY,A.KNITRECQTY,A.KNITBAL,A.DYERECQTY,
 A.INBAL,2 ORD,'KNITTING INHOUSE' TYPENAME FROM FABINHOUSE A UNION ALL SELECT A.FINYR,A.BUYERNAME,A.BUYERCODE,A.ORDERNO,A.BUYERPONO,A.STYLE,A.ORDERQTY,
 A.YPOQTY,A.YARNQTY,A.KNITRECQTY,A.KNITBAL,A.DYERECQTY,A.INBAL,1 ORD,'YARN' TYPENAME FROM FABINHOUSE A) A 
 WHERE A.FINYR = '${finyear}' AND ('${buyer}' = 'ALL' OR A.BUYERCODE = '${buyer}')

  AND ('${typeName}' = 'ALL' OR A.TYPENAME = '${typeName}') ORDER BY A.ORD,A.BUYERCODE
`;
