  ...
  return (
    <>
      ...
      <div
        style={{
          backgroundImage:
            "url('https://png.pngtree.com/thumb_back/fh260/background/20220428/pngtree-attractive-advertise-blank-banner-copyspace-vector-image_1102577.jpg')",
            ...
            return (
              ...
              >
                <div className="bg-white/95 backdrop-blur-md border border-stone-200 rounded-full rounded-xl p-5 text-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className={`text-4xl mb-3 ${product.color}`}>
                    {product.icon}
                  </div>
                  <h3 className="text-lg font-bold mb-1 text-stone-800">
                    {product.title}
                  </h3>
