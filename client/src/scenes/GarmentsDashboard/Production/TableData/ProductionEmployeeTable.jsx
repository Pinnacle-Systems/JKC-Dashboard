...
import { useGetProductionEfficiencyManpowertableQuery } from "../../../../redux/service/production";
...
const ProductionEmployeeTable = ({
  ...
  const handleExport = async () => {
    ...
    ws.insertRow(1, ["Production Man Power"]);
    ...
    saveAs(
      ...
      `Production_Man Power_${companyName}_${selectedProcess}_${selectedDate}.xlsx`,
    );
  };
...
export default ProductionEmployeeTable;
