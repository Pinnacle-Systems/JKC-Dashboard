...
import { useGetProductionEfficiencyManpowerQuery } from "../../../redux/service/production";
import ProductionEmployeeTable from "./TableData/ProductionEmployeeTable";
...
const ProductionEmployee = ({ companyName }) => {
  ...
  const { data: response, isLoading } = useGetProductionEfficiencyManpowerQuery(
    {
