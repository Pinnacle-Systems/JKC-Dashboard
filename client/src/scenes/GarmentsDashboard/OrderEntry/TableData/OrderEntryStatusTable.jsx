...
const OrderEntryStatusTable = ({
  ...
  const {
    ...
    { skip: !selectedYear || !selectedComp || !selectedType },
  );
        ...
        >
          {selectedType === "INTERNAL ORDER" ? (
                ...
                {isLoading || isFetching ? (
                  ...
                  currentRows.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="border p-1 pr-2 text-right ">
                        {formatQtyByUOM(row.totProdQty, row.orderUom)}
                      </td>
            ...
            <div className="flex flex-col items-center justify-center h-full text-gray-400 gap-2">
              <p className="text-sm font-semibold">"{selectedType}"</p>
              <p className="text-xs">Table will be implemented soon.</p>
            </div>
          )}
        </div>
